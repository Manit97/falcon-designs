...
// --- Main Hero Component ---
export const WovenLightHero = ({ hideContent = false, bgColor = "#000000" }: { hideContent?: boolean; bgColor?: string }) => {
  ...
  return (
    <div className="relative flex h-screen w-full flex-col items-center justify-center overflow-hidden" style={{ backgroundColor: bgColor, transition: 'background-color 0.8s ease' }}>
      <WovenCanvas />
      {!hideContent && (
        <>
          <HeroNav />
